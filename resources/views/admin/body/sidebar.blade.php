      ...
      <ul class="sidebar-menu" data-widget="tree">  
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{route('user.add')}}"><i class="ti-more"></i>Tambahkan User</a></li>
          </ul>
        </li> 
         <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{route('barang.add')}}"><i class="ti-more"></i>Tambahkan Barang</a></li>
          </ul>
        </li> 
         </li> 
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{route('kuliah.add')}}"><i class="ti-more"></i>Tambahkan Kuliah</a></li>
          </ul>
        </li> 
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('barang.view')}}"><i class="ti-more"></i>Inbox</a></li>
            <li><a href="{{route('barang.add')}}"><i class="ti-more"></i>Compose</a></li>
             <li><a href="{{route('barang.add')}}"><i class="ti-more"></i>Read</a></li>
          </ul>
        </li>
