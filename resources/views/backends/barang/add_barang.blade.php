    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col">
              <form method="post" action="{{route('barang.request')}}">
                @csrf
                <div class="row">
                  <!-- <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="controls">
                        <input type="text" name="harga" class="form-control" required data-validation-required-message="This field is required">
                      </div>
                      <div class="form-control-feedback"><small>Add <code>required</code> attribute to field for required validation.</small></div>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="controls">
                        <input type="text" name="jumlah" class="form-control" required data-validation-required-message="This field is required">
                      </div>
                    </div>
                  </div>
